...
import { Box, Flame, Cat, Rabbit, Users, Code2, Wand2, Hammer, FolderOpen, ChevronUp, FileJson, History, Play, Pause, Info, Wrench, Loader2 } from 'lucide-react';
...
interface UIOverlayProps {
  ...
  onDismantle: () => void;
  onRebuild: (type: 'RunawayDevil' | 'Cat' | 'Rabbit' | 'TwinDevils') => void;
  onNewScene: (type: 'RunawayDevil') => void;
...
export const UIOverlay: React.FC<UIOverlayProps> = ({
  ...
  // Only show default presets if the current model is the original Devil
  const isDevil = currentBaseModel === 'RunawayDevil';
      ...
      <div className="absolute top-4 left-4 right-4 flex justify-between items-start">
        ...
        <div className="pointer-events-auto flex flex-col gap-2">
            ...
            >
                ...
                <DropdownItem onClick={() => onNewScene('RunawayDevil')} icon={<Flame size={16}/>} label="Runaway Devil" />
            ...
            {isDismantling && !isGenerating && (
                <div className="flex items-end gap-4 animate-in slide-in-from-bottom-10 fade-in duration-300">
                     ...
                     >
                        ...
                        {/* Standard Presets - Only for Devil */}
                        {isDevil && (
                            <>
                                ...
                                <DropdownItem onClick={() => onRebuild('TwinDevils')} icon={<Users size={18}/>} label="Devils x2" />
                                <div className="h-px bg-slate-100 my-1" />
                            </>
                        )}
